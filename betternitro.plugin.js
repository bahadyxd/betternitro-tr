 ...
 * @source https://raw.githubusercontent.com/bahadyxd/betternitro-tr/main/betternitro.plugin.js
 * @updateUrl https://raw.githubusercontent.com/bahadyxd/betternitro-tr/main/betternitro.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
    const config = {
        "info": {
            ...
            "authors": [{
                "name": "bahady",
                "discord_id": "739126599093321771",
                "github_username": "bahadyxd"
            }],
            "version": "1.0.0",
            "description": "BetterNitro | Bahady - Cr: Asreaper",
            "github": "https://github.com/bahadyxd",
            "github_raw": "https://github.com/bahadyxd"
        },
                ...
                getSettingsPanel() {
                    return Settings.SettingPanel.build(_ => this.saveAndUpdate(), ...[
                        new Settings.SettingGroup("Özellikler").append(...[
                            new Settings.Switch("Yüksek Kalitede Ekran Paylaşımı", "Aktif Et Veya Kapat 1080p/kaynak @ 60fps Ekran Paylaşımı ", this.settings.screenSharing, value => this.settings.screenSharing = value)
                        ]),
                        new Settings.SettingGroup("Emoji").append(
                            new Settings.Switch("Haraketli / Haraketsiz Emoji Kullanma", "Nitrosuz Emojiyi Aç", this.settings.emojiBypass, value => this.settings.emojiBypass = value),
